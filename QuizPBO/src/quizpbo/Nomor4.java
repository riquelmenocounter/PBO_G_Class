...
public class Nomor4 {
    ...
    public static void main(String[] args) {
        File InputFile = new File("C:\\Users\\Pongo\\QuizPBO\\inputno4.txt");
        File OutputFile = new File("C:\\Users\\Pongo\\QuizPBO\\outputno4.txt");
    ...
    public static String ubahKeAngka(String teks) {
        StringBuilder BangunString = new StringBuilder();
        teks = teks.toUpperCase(); 

        for (int i = 0; i < teks.length(); i++) {
            char karakter = teks.charAt(i);
            if (karakter >= 'A' && karakter <= 'Z') {
                int nilai = karakter - 'A' + 1;
                BangunString.append(nilai);
            } else if (karakter == ' ') {
                BangunString.append(" "); 
            }
        }
